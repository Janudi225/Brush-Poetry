...
function validateCheckForm() {
    ...
    if (!cardNumFormat.test(cardNum)) {
        alert("Please enter a integer value for card number");
        return false;
    }
    if (!holderNameFormat.test(holderName)) {
        alert("Please enter a text type for card holder name");
        return false;
    }
    if (!expmonthFormat.test(expmonth)) {
        alert("Please enter a integer value for expiry month");
        return false;
    }
    if (!expyearFormat.test(expyear)) {
        alert("Please enter a integer value for expiry year");
        return false;
    }
    if (!cvvFormat.test(cvv)) {
        alert("Please enter a integer value for cvv code");
        return false;
    }
    return true;
}
